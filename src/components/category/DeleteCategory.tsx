...
import deleteCategory from '../../api/category/deleteCategory.ts'
    ...
    <Dialog size="sm" open={ open } handler={ handleOpen }>
      ...
      <DialogBody divider>
        <Typography className="font-normal">
          This will delete "{ category.name }" <b>category</b> and <b>all</b> its <b>questions
          ({ category.questionCount })</b> permanently.
          <br/>
