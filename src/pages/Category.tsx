  ...
  return (
    <>
      ...
      <div className="flex gap-1 items-center mt-4">
        ...
        <Select
          label="Difficulty"
          onChange={ (difficulty): void => applySearchParams({ difficulty }) }
        ...
        <Select
          label="Type"
          onChange={ (type): void => applySearchParams({ type }) }
        ...
        <Input
          ...
          onChange={ (e): void => applySearchParams({ search: e.target.value }) }
          icon={ <MagnifyingGlassIcon className="h-4 w-4"/> }/>

        <Select
          label="Size"
          onChange={ (size): void => applySearchParams({ size }) }
